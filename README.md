...
> AI 驱动的多角色辩论系统 — 选择历史人物或思想家作为辩者，围绕你的问题展开跨时空辩论，支持实时 SSE 流式观看和 Markdown/JSON/PDF 导出。

### ✨ 功能

- **角色选择** — 从 50+ 古今中外思想家中选择 2-6 位辩者 + 1 位裁判
- **完整辩论流程** — 立论 → 交叉质询（多轮） → 结辩 → 投票 → 裁判总结
- **SSE 实时流式** — 每位辩者的发言逐 token 实时推送
- **多格式导出** — Markdown / JSON / PDF
